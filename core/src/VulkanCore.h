...
namespace lab {
    ...
    class VulkanCore {
        ...
        void requestResize() { m_Resized = true; }

        const VulkanContext& getContext() const { return m_VulkanCtx; }
        VkDevice getDevice() const { return m_VulkanCtx.getDevice(); }
        VmaAllocator getAllocator() const { return m_VulkanCtx.getAllocator(); }
        Window& getWindow() { return m_Window; }
        VkFormat getColorFormat() const { return m_Swapchain.getImageFormat(); }
        VkFormat getDepthFormat() const { return m_Swapchain.getDepthFormat(); }
